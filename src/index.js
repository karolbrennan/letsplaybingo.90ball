	...
	<Router>
		<header>
			<div className="container row align-center">
				...
				<div className="col shrink no-text-wrap padding-left-xxlg">
					<h3 className="dark-gray-text">90 Ball!</h3>
				</div>
				<div className="col grow padding-horizontal-md no-text-wrap text-right">
					<ul className="menu">
						<li>
							<Link to="/">Play</Link>
						</li>
						<li>
							<Link to="/generator">Ticket Generator</Link>
						</li>
						<li>
