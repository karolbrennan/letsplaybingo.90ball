				...
				<div className="container row">
					<div id="top" className="col">
						...
						<p>
							...
							second time. <em>For example:</em> the caller will read out 26
							followed by "2 6" with each number separated phonetically. This is
							meant to emulate how callers call the numbers in bingo halls.
						</p>
						...
						<p>
							...
							game mode, "Let's Play Wild Bingo!". It will also call out the fun
							names for each number like when "1" is called it might say "Number
							Ace".
						</p>
						...
						<p>
							...
							would mark every number ending in 6.
						</p>
						<p className="small-text">
						...
						<p className="margin-top-none">
							...
							manual calling mode, all buttons will be disabled.
						</p>
